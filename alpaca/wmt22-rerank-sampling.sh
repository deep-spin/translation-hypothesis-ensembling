main(){
    ...
    do
        ...
        translations_file=$translations_original-processed
        ...
        best_cometkiwi=$output_file_dir/rerank-cometkiwi/prompt$prompt-t$temperature-topp$top_p-beam$beam-n$n_samples
        best_cometoracle=$output_file_dir/rerank-cometoracle/prompt$prompt-t$temperature-topp$top_p-beam$beam-n$n_samples
        single_pred=$output_file_dir/rerank-singleprediction/prompt$prompt-t$temperature-topp$top_p-beam$beam-n$n_samples
        ...
        metrics_corpus_cometkiwi=$metrics_dir/corpus/prompt$prompt-t$temperature-topp$top_p-beam$beam-n$n_samples-cometkiwi
        metrics_segment_cometkiwi=$metrics_dir/segment/prompt$prompt-t$temperature-topp$top_p-beam$beam-n$n_samples-cometkiwi
        metrics_corpus_cometoracle=$metrics_dir/corpus/prompt$prompt-t$temperature-topp$top_p-beam$beam-n$n_samples-cometoracle
        metrics_segment_cometoracle=$metrics_dir/segment/prompt$prompt-t$temperature-topp$top_p-beam$beam-n$n_samples-cometoracle
        metrics_corpus_singlepred=$metrics_dir/corpus/prompt$prompt-t$temperature-topp$top_p-beam$beam-n$n_samples-singlepred
        metrics_segment_singlepred=$metrics_dir/segment/prompt$prompt-t$temperature-topp$top_p-beam$beam-n$n_samples-singlepred
